...
public class TicTieToeBoard extends View {
    ...
    public TicTieToeBoard(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);

        game = new GameLogic();

        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.TicTieToeBoard,0,0);

        try {
            boardColor = a.getInteger(R.styleable.TicTieToeBoard_boardColor,0);
            X_color = a.getInteger(R.styleable.TicTieToeBoard_X_color,0);
            O_color = a.getInteger(R.styleable.TicTieToeBoard_O_color,0);
            winningLineColor = a.getInteger(R.styleable.TicTieToeBoard_winningLineColor,0);
        } finally {
            a.recycle();
        }
